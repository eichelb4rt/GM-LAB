...
The number of paramaters in the generated structures is $n_{params} = 2 \abs{V_G} + \abs{E_G}$ for any structure $G$.
This decreases when $\lambda$ increases.
This is illustrated in \autoref{fig:results:n_params}.
\begin{figure}
	\centering
	\includegraphics[scale=0.3]{graphics/n_params.png}
	\caption{Number of parameters vs $\lambda$}
